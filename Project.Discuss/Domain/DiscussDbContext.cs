...
public partial class DiscussDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BbsArticle>(entity =>
        {
            ...
            entity.HasOne(a => a.BbsArticleContent).WithOne(c => c.BbsArticle).HasForeignKey<BbsArticleContent>(c => c.ArticleId); 
        ...
        modelBuilder.Entity<ImgDto>().HasNoKey();  // 标记 ImgDto 为没有主键的类型
